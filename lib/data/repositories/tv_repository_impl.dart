...
class TvRepositoryImpl implements TvRepository {
  ...
  Future<Either<Failure, String>> saveTvWatchlist(TvDetail movie) async {
    try {
      final result = await localDataSource.insertTvWatchlist(TvTable.fromEntity(movie));
      return Right(result);
  ...
  Future<Either<Failure, String>> removeTvWatchlist(TvDetail movie) async {
    try {
      final result = await localDataSource.removeTvWatchlist(TvTable.fromEntity(movie));
      return Right(result);
    } on DatabaseException catch (e) {
      return Left(DatabaseFailure(e.message));
    }
